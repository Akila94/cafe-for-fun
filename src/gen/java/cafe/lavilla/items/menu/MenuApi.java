...
public class MenuApi {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Deletes the given food item of the given category", notes = "This " +
            "API is used to delete a given food item of given category\n", response = FoodItem.class)
    ...
    public Response deleteFoodItem(
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Gets all food categories",
            notes = "This API is used to get all food categories\n", response = CategoryDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Gets all the foods of the provided category",
            notes = "This API is used to get all the food items of the given category\n", response = GroupDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200,
                    message = "Successfully obtained food item of given category"),

            @io.swagger.annotations.ApiResponse(code = 404, message = "Provided category not found")})

    public Response getCategory(@ApiParam(value = "Food category that is needed", required = true) @PathParam
            ("category") int categoryId) {
        return delegate.getItemsByCategory(categoryId);
    }
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Get the food item of a given id and a category",
            notes = "This API is used to get a food item for the given id and category\n",
    ...
    public Response getFoodItem(/*@ApiParam(value = "Category of the food",required=true ) @PathParam("category")  int
                                            categoryId,*/
                                @ApiParam(value = "Id of the food item to get", required = true) @PathParam("id")
                                        Integer id) {
    ...
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Adds an image for a food item",
            notes = "This API adds an image to a food item\n", response = ImageDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "OK")})

    public Response menuImageUploadTmpPost(
            @ApiParam(value = "The image to be uploaded") @Multipart(value = "image", required = false)
                    InputStream imageInputStream,
            @ApiParam(value = "The image to be uploaded : details") @Multipart(value = "image", required = false)
                    Attachment imageDetail) {
    ...
    @Consumes({"multipart/form-data"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Updates the image of a food item",
            notes = "This API updates the image of a food item\n", response = SuccessDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "OK")})

    public Response menuImageUploadTmpPut(
            @ApiParam(value = "The image to be updated") @Multipart(value = "image", required = false)
                    InputStream imageInputStream,
            @ApiParam(value = "The image to be updated : details") @Multipart(value = "image", required = false)
                    Attachment imageDetail) {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Add items", notes = "Adding food item details to the database",
            response = FoodDetailsDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 201,
                    message = "Successfully added the food item to the database"),

            @io.swagger.annotations.ApiResponse(code = 400, message = "Bad request")})

    public Response menuItemConfigurationPost(
            @ApiParam(value = "Details of the food item to be stored in database", required = true)
                    FoodDetailsDTO foodItem) {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Delete a item category", notes = "",
            response = CategoryDetailsDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "OK"),
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Update a item category", notes = "",
            response = CategoryDetailsDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "OK"),
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Adds a food item of a given category",
            notes = "This API is used to add a food item of a given category\n", response = FoodDetailsDTO.class)
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "OK"),
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Updates the food item of a given id and a category.",
            notes = "This API is used to update a given food item of a given category\n", response = void.class)
    @io.swagger.annotations.ApiResponses(value = {
    ...
    public Response updateFoodItem(
